...
df = pd.read_csv("/Users/jeysurya/Desktop/Credit card default pred/BankChurners.csv")
...
model = RandomForestClassifier(criterion='entropy', max_depth = 24, max_features = 'sqrt', min_samples_leaf = 1, min_samples_split = 7, n_estimators = 143)
model.fit(x,y)
